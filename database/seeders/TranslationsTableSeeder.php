...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function dataTypesTranslations()
    {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.users.singular'))->firstOrFail();
        if ($dtp->exists) {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.users.plural'))->firstOrFail();
        if ($dtp->exists) {
